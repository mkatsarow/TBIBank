...
;(function (global, factory) {
    ...
    function valid__createInvalid (flags) {
        let m = create_utc__createUTC(NaN);
        if (flags != null) {
    ...
    let momentProperties = utils_hooks__hooks.momentProperties = [];
    ...
    function currentDateArray(config) {
        ...
        let nowValue = new Date(utils_hooks__hooks.now());
        if (config._useUTC) {
    ...
    let prototypeMin = deprecate(
         ...
         function () {
             let other = local__createLocal.apply(null, arguments);
    ...
    function isDaylightSavingTimeShifted () {
        ...
        if (c._a) {
            let other = c._isUTC ? create_utc__createUTC(c._a) : local__createLocal(c._a);
    ...
    let add_subtract__add      = createAdder(1, 'add');
    let add_subtract__subtract = createAdder(-1, 'subtract');
    ...
    function moment_calendar__calendar (time, formats) {
        ...
        let output = formats && (isFunction(formats[format]) ? formats[format]() : formats[format]);
    ...
    let momentPrototype__proto = Moment.prototype;
    ...
    let momentPrototype = momentPrototype__proto;
    ...
    let prototype__proto = Locale.prototype;
    ...
    function lists__get (format, index, field, setter) {
        ...
        let utc = create_utc__createUTC().set(setter, index);
    ...
    function duration_add_subtract__addSubtract (duration, input, value, direction) {
        let other = create__createDuration(input, value);
    ...
    function duration_humanize__relativeTime (posNegDuration, withoutSuffix, locale) {
        let duration = create__createDuration(posNegDuration).abs();
    ...
    function iso_string__toISOString() {
        ...
        let days         = iso_string__abs(this._days);
    ...
    let duration_prototype__proto = Duration.prototype;
    ...
    let _moment = utils_hooks__hooks;
